window.skins={};
	...
	function ButtonDanger() {
		...
		this.states = [
			...
			new eui.State ("down",
				[
					new eui.SetProperty("_Image1","source","danger_down_png")
				])
			,
	...
	var _proto = ButtonDanger.prototype;
	...
	function ButtonDefault() {
		...
		this.states = [
			...
			new eui.State ("down",
				[
					new eui.SetProperty("_Image1","source","default_down_png")
				])
			,
			new eui.State ("disabled",
				[
	...
	var _proto = ButtonDefault.prototype;
	...
	function ButtonInfo() {
		...
		this.states = [
			...
			new eui.State ("down",
				[
					new eui.SetProperty("_Image1","source","info_down_png")
				])
			,
			new eui.State ("disabled",
				[
	...
	var _proto = ButtonInfo.prototype;
	...
	function ButtonPrimary() {
		...
		this.states = [
			...
			new eui.State ("down",
				[
					new eui.SetProperty("_Image1","source","primary_down_png")
				])
			,
			new eui.State ("disabled",
				[
	...
	var _proto = ButtonPrimary.prototype;
